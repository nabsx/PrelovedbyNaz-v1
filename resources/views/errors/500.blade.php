            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="float-animation">
                            <div class="w-48 h-48 bg-gradient-to-br from-pink-200 to-pink-300 rounded-full flex items-center justify-center pulse-glow">
                                <div class="text-center">
                                    <i class="fas fa-server text-pink-600 text-6xl mb-4 block"></i>
                                    <p class="text-pink-700 font-bold text-sm">Server Error</p>
                                </div>
                            </div>
                        </div>
                        <!-- Decorative circles -->
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed">
                        Oops! Terjadi kesalahan pada server kami. Tim kami sudah diberitahu dan sedang menangani masalah ini. Silakan coba lagi dalam beberapa saat.
                    </p>
                    ...
                    <div class="mt-8 pt-8 border-t border-pink-200">
                        <p class="text-gray-600 text-sm mb-4">Hubungi kami jika masalah berlanjut</p>
